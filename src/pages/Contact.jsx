  ...
  return (
    <div ref={pageRef} style={{ background: 'var(--bg)', minHeight: '100vh', display: 'flex', flexDirection: 'column', gap: 100 }}>
      ...
      <section style={{ padding: '0 100px', display: 'flex', flexDirection: 'column', gap: 25 }}>
        <h1 style={{ fontSize: 32, fontWeight: 700 }}>Contact</h1>
        <p style={{ fontSize: 24, fontWeight: 500, opacity: 0.8, maxWidth: 802 }}>
        ...
        <div className="reveal" style={{ display: 'flex', gap: 25, alignItems: 'flex-start' }}>
          ...
          <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: 10 }}>
            ...
            <div style={{ background: 'var(--white)', border: '3px solid var(--black)', borderRadius: 25, padding: 30, boxShadow: '3px 3px 0 var(--black)', display: 'flex', flexDirection: 'column', gap: 15 }}>
              ...
              <p style={{ fontSize: 32, fontWeight: 700 }}>+91 8296158346</p>
              <a
                href="https://wa.me/918296158346"
                target="_blank"
                rel="noreferrer"
                style={{ display: 'inline-flex', alignItems: 'center', background: 'var(--green)', border: '2px solid var(--black)', borderRadius: 15, padding: '7.5px 15px', boxShadow: '4px 4px 0 var(--black)', textDecoration: 'none', fontSize: 18, fontWeight: 500, color: 'var(--black)', cursor: 'pointer', transition: 'transform .15s' }}
